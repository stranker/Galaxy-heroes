...
func inicializar():
	...
	get_node("PanelVida/Planeta/ProgressBar").edit_set_rect(Rect2(Vector2(0,0),Vector2(get_node("PanelVida").get_rect().size.width/1.4,30)))
	get_node("PanelEnergia/Energia/ProgressBar").edit_set_rect(Rect2(Vector2(0,0),Vector2(get_node("PanelEnergia").get_rect().size.width/1.4,30)))
	get_node("PanelVida/Planeta/ProgressBar").set_global_pos(Vector2(get_node("PanelVida/Planeta").get_pos().x + get_node("PanelVida/Planeta").get_rect().size.width,get_node("PanelVida/Planeta").get_pos().y))
	get_node("PanelEnergia/Energia/ProgressBar").set_global_pos(Vector2(get_node("PanelEnergia/Energia").get_pos().x + get_node("PanelEnergia/Energia").get_rect().size.width,get_node("PanelEnergia/Energia").get_pos().y))
	pass
